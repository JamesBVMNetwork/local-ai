    ...
    def start(self, hash: str, port: int = 11434, host: str = "0.0.0.0", context_length: int = 32768) -> bool:
        ...
        try:
            ...
            if "gemma" in folder_name.lower():
                ...
                template_path = pkg_resources.resource_filename("local_ai", "examples/gemma3_template.jinja")
                running_llm_command = [
                    llama_server_path,
                ...
                template_path = pkg_resources.resource_filename("local_ai", "examples/qwen25_template.jinja")
                running_llm_command = [
                    llama_server_path,
                    "--model", str(local_model_path),
                    "--port", str(llm_running_port),
                ...
                template_path = pkg_resources.resource_filename("local_ai", "examples/qwen3_template.jinja")
                running_llm_command = [
                    llama_server_path,
                    "--model", str(local_model_path),
                    "--port", str(llm_running_port),
                ...
                template_path = pkg_resources.resource_filename("local_ai", "examples/llama31_template.jinja")
                running_llm_command = [
                    llama_server_path,
                    "--model", str(local_model_path),
                    "--port", str(llm_running_port),
